...
Dynamics 365 ist eine Online-Geschäftsanwendungssuite, die die Crm-Funktionen (Customer Relationship Management) und deren Erweiterungen in die Erp-Funktionen (Enterprise Resource Planning) integriert. Diese End-to-End-Geschäftsanwendungen helfen Kunden, Beziehungen in Umsatz umzuwandeln, Kunden zu verdienen und das Wachstum des Unternehmens zu beschleunigen. Dynamics 365 ist eine SaaS-Suite (Software as a Service), die auf der Azure-Infrastruktur basiert und kunden weltweit über ihre global verteilten Rechenzentren zur Verfügung gestellt wird.
...
Hinsichtlich der Skalierung verwendet Microsoft derzeit fast eine Million Computer, um Microsoft 365 Dienste zu unterstützen. Die Infrastruktur für diese Dienste variiert je nach dienstspezifischer Hardware und virtualisierten Umgebungen in Azure, Windows und Linux sowie auf mehreren Mandanten und dedizierten Plattformen stark. Microsoft 365 ist ein globales Unternehmen, und unsere Infrastruktur ist in Rechenzentren auf der ganzen Welt verteilt, so dass unsere Kunden die Anforderungen an die Datenspeicherung und Souveränität der Daten erfüllen können.
