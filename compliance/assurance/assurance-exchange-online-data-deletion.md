...
## <a name="soft-deleted-and-hard-deleted-mailboxes"></a>Soft-Deleted-und Hard-Deleted-Postfächer

Ein vorläufig gelöschtes Benutzerpostfach ist ein Postfach, das mit dem Microsoft 365 Admin Center oder dem Remove-Mailbox-Cmdlet gelöscht wurde und sich noch weniger als 30 Tage im Papierkorb von Azure Active Directory befindet. Ein Postfach kann auf eine der folgenden Arten vorläufig gelöscht werden:
...
## <a name="soft-deleted-and-hard-deleted-items"></a>Elemente für Soft-Deleted und Hard-Deleted
