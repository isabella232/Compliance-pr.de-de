...
Zur Verwaltung von Untersuchungen auf einen Antrag einer Person in Ihrer Organisation hin können Sie das DSR-Falltool im Security & Compliance Center verwenden, und damit nach Inhalten suchen, die an folgenden Orten gespeichert sind:
...
Standardmäßig kann ein globaler Administrator im Security & Compliance Center auf das DSR-Falltool zugreifen. Normalerweise haben andere Benutzer, z. B. ein Datenschutzbeauftragter, ein Personalmanager oder andere an DSR-Untersuchungen beteiligte Personen, keinen Zugriff auf das DSR-Falltool. Hierfür müssen ihnen zuerst die entsprechenden Berechtigungen zugewiesen werden. Am einfachsten geht das, indem Sie im Security & Compliance Center auf der Seite **Berechtigungen** Benutzer zur Rollengruppe "eDiscovery-Manager" hinzufügen. Sie müssen ihnen außerdem diese Berechtigungen zuweisen, damit Sie sie als Mitglieder des in Schritt 2 zu erstellenden DSR-Falls hinzufügen können. 
  
Eine schrittweise Anleitung hierzu finden Sie unter [Zuweisen von eDiscovery-Berechtigungen im Office 365 Security & Compliance Center](/microsoft-365/compliance/assign-ediscovery-permissions).
...
1. Wechseln Sie zu [https://protection.office.com](https://protection.office.com), und melden Sie sich mit Ihrem Arbeits-, Uni- oder Schulkonto an. 
    
2. Klicken Sie im Security & Compliance Center auf **Datenschutz** \> **Anträge betroffener Personen**, und klicken Sie dann auf ![Hinzufügen-Symbol](../media/ITPro-EAC-AddIcon.gif) **Neuer Fall für einen Antrag einer betroffenen Person**.
    
3. Geben Sie auf der Flyoutseite **Neuer Fall** einen Namen für den Fall und optional eine Beschreibung ein, und klicken Sie dann auf **Weiter**. Der Name des Falls darf in der Organisation nur einmalig vorkommen.
...
4. Wählen Sie auf der Seite **Antragsdetails** unter **Betroffene Person** (die Person, die diesen Antrag eingereicht hat) die Person aus, deren Daten Sie suchen und exportieren möchten, und klicken Sie dann auf **Weiter**.
    
5. Auf der Seite **Falleinstellungen** können Sie den Namen und die Beschreibung des Falls ändern und eine andere betroffene Person auswählen. Klicken Sie andernfalls auf **Speichern**.
...
6. Klicken Sie auf **Fertigstellen**, um zum neuen DSR-Fall wechseln und ihm Mitglieder hinzufügen zu können. 
    
7. Klicken Sie auf der Seite **Anträge betroffener Personen** auf den Namen des vorhin erstellten DSR-Falls. 
    
8. Klicken Sie auf der Flyoutseite **Fall verwalten** unter **Mitglieder verwalten** auf **Hinzufügen**. 
...
9. Wählen Sie die Personen aus, die sie als Mitglieder des DSR-Falls hinzufügen möchten, klicken Sie auf **Hinzufügen**, und speichern Sie dann Ihre Änderungen.
...
1. Klicken Sie im Security & Compliance Center auf **Datenschutz** \> **Anträge betroffener Personen** und dann neben dem DSR-Fall, den Sie in Schritt 2 erstellt haben, auf **Öffnen**. 
    
    Klicken Sie oben auf die Registerkarte **Suchen**, und setzen Sie dann ein Häkchen neben der integrierten Suche, die beim Erstellen des DSR-Falls erstellt wurde. Die Suche ist wie der DSR-Fall benannt. 
    
2. Klicken Sie auf der Flyoutseite "Suchen" auf **Abfrage öffnen**.
    
    Durch das Öffnen der Abfrage wird die Suche gestartet, die nach kurzer Zeit abgeschlossen sein wird. 
    
3. Wenn die Suche abgeschlossen ist, klicken Sie auf **Vorschau der Ergebnisse**, um eine Vorschau der Suchergebnisse anzuzeigen. Weitere Informationen finden Sie unter [Vorschau von Suchergebnissen anzeigen](/microsoft-365/compliance/content-search#preview-search-results).
...
1. Klicken Sie im Security & Compliance Center auf **Datenschutz** \> **Anträge betroffener Personen** und dann neben dem DSR-Fall, aus dem Sie Daten exportieren möchten, auf **Öffnen**. 
    
2. Klicken Sie oben auf die Registerkarte **Suchen**, und setzen Sie dann ein Häkchen neben der integrierten Suche, die beim Erstellen des DSR-Falls erstellt wurde. Oder klicken Sie auf eine andere Suche, um Daten aus dieser zu exportieren. 
    
3. Klicken Sie auf der Flyoutseite "Suche" auf ![Symbol "Suchergebnisse exportieren"](../media/47205c65-babd-4b3a-bd7b-98dfd92883ba.png) **Mehr**, und wählen Sie dann aus der Dropdownliste die Option **Ergebnisse exportieren** aus. 
...
1. Klicken Sie im Security & Compliance Center auf **Datenschutz** \> **Anträge betroffener Personen** und dann neben dem DSR-Fall für die betroffene Person, für die Sie Nutzungsdaten exportieren möchten, auf **Öffnen**. 
 ...
 **So exportieren Sie Office-Roamingdienst-Daten:**
...
2. Klicken Sie auf der Flyoutseite "Suche" auf ![Symbol "Suchergebnisse exportieren"](../media/47205c65-babd-4b3a-bd7b-98dfd92883ba.png) **Mehr**, und wählen Sie dann aus der Dropdownliste die Option **Ergebnisse exportieren** aus. 
...
Ebenso werden Postfächer und SharePoint-Sites, die einer Microsoft 365-Gruppe zugeordnet sind, in die integrierte Suche einbezogen. Dies bedeutet, dass E-Mail-Nachrichten zurückgegeben werden, die von der betroffenen Person gesendet oder empfangen wurden, sowie von ihr erstellte oder hochgeladene Dateien. 
  
Weitere Informationen zum Verwenden der Inhaltssuche zum Suchen nach Elementen in Microsoft Teams und Microsoft 365-Gruppen oder zum Abrufen einer Liste von Mitgliedern finden Sie im Abschnitt "Durchsuchen von Microsoft Teams und Microsoft 365-Gruppen" unter [Inhaltssuche in Microsoft 365](/microsoft-365/compliance/content-search#searching-microsoft-teams-and-microsoft-365-groups). 
