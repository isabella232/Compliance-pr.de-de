...
## <a name="hitrust--csf-overview"></a>HITRUST – CSF-Übersicht

Die Health Information Trust Alliance (HITRUST) ist eine Organisation, die von Vertretern der Gesundheitsbranche bestimmt wird. HITRUST hat das Common Security Framework (CSF) erstellt und verwaltet, ein zertifizierbares Framework, mit dem Organisationen des Gesundheitswesens und ihre Anbieter ihre Sicherheit und Compliance auf konsistente und optimierte Weise demonstrieren können.

Das CSF baut auf HIPAA und dem HITECH Act auf, bei denen es sich um US-Gesundheitsgesetze handelt, die Anforderungen für die Verwendung, Offenlegung und den Schutz von individuell identifizierbaren Gesundheitsinformationen festgelegt haben und die Nichtkompatibilität erzwingen. HITRUST bietet einen Benchmark – ein standardisiertes Complianceframework, eine Bewertung und einen Zertifizierungsprozess –, an dem Clouddienstanbieter und abgedeckte Integritätsentitäten die Compliance messen können. Das CSF umfasst auch gesundheitsspezifische Sicherheits-, Datenschutz- und andere gesetzliche Anforderungen aus vorhandenen Frameworks wie dem Payment Card Industry Data Security Standard ([PCI-DSS](https://www.microsoft.com/trustcenter/compliance/pci)), [ISO/IEC 27001](https://www.microsoft.com/trustcenter/compliance/iso-iec-27001) Information Security Management Standards und Minimum Acceptable Risk Standards for Exchanges ([MARS-E](https://www.microsoft.com/trustcenter/compliance/mars-e)).

Das CSF ist in 19 verschiedene Domänen unterteilt, einschließlich Endpunktschutz, Sicherheit mobiler Geräte und Zugriffssteuerung. HITRUST zertifiziert IT-Angebote für diese Steuerelemente. HITRUST passt die Anforderungen für die Zertifizierung auch an die Risiken einer Organisation basierend auf organisatorischen, systembasierten und regulatorischen Faktoren an.

Health Information Trust Alliance (HITRUST) Common Security Framework (CSF)

HITRUST bietet drei Grad an Zuverlässigkeit oder Bewertungsebenen: Selbstbewertung, CSF-validiert und CSF-zertifiziert. Jede Ebene baut mit zunehmender Strenge auf der darunter stehenden Ebene auf. Eine Organisation mit der höchsten Stufe, CSF-zertifiziert, erfüllt alle Zertifizierungsanforderungen des CSF. Microsoft Azure und Office 365 sind die ersten Hyperscale-Clouddienste, die eine Zertifizierung für den HITRUST CSF erhalten. Coalfire, eine HITRUST-Bewertungsfirma, hat die Bewertungen basierend darauf durchgeführt, wie Azure und Office 365 Sicherheits-, Datenschutz- und behördliche Anforderungen zum Schutz vertraulicher Informationen implementieren. Microsoft unterstützt das HITRUST Shared Responsibility Program.

Erfahren Sie, wie Sie Ihre HITRUST-Bereitstellung mit unserem Azure Security and Compliance Blueprint beschleunigen.

[Herunterladen des Microsoft Azure HITRUST Customer Responsibility Matrix (CRM)-Blueprints v9.0d](https://servicetrust.microsoft.com/ViewPage/Blueprint?command=Download&downloadType=Document&downloadId=3ccde498-4761-4be0-be8b-cd8d379a3a4f&docTab=fc060920-cdb8-11e7-bacf-0bf52b09d912_Healthcare_Blueprint)
...
- [Azure HITRUST-Zertifizierungsschreiben](https://servicetrust.microsoft.com/ViewPage/MSComplianceGuideV3?command=Download&downloadType=Document&downloadId=02eaae7a-9d65-42e6-aec8-a8e22de1a494&tab=7027ead0-3d6b-11e9-b9e1-290b1eb4cdeb&docTab=7027ead0-3d6b-11e9-b9e1-290b1eb4cdeb_GRC_Assessment_Reports)
...
- [Verstehen und Nutzen des CSF](https://hitrustalliance.net/understanding-leveraging-csf/)
- [Erfahren Sie mehr über das HITRUST Shared Responsibility Program](https://go.microsoft.com/fwlink/p/?linkid=2100268)
